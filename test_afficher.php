								...
								<div class="card">
									...
									<div class="card-body">
										...
										<table id="myTable" class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												<tr>
													<th onclick="sortTable(0)" class="text-center">E_mail</th>
													<th onclick="sortTable(1)" class="text-center">mot de passe</th>
													<th onclick="sortTable(2)" class="text-center">cin</th>
													<th onclick="sortTable(3)" class="text-center">nom</th>
													<th onclick="sortTable(4)" class="text-center">prenom</th>
													<th onclick="sortTable(5)" class="text-center">adresse</th>
													<th onclick="sortTable(6)" class="text-center">numero</th>
													<th onclick="sortTable(7)" class="text-center">type</th>
...
<tr>
   ...
   <input type="hidden" value="<?PHP echo $row['cin_client']; ?>"name="cin_client">
	 </form>
  </td>
  <td><a href="modifier.php?cin_client=<?PHP echo $row['cin_client']; ?>">Modifier</a>
  </td>
</tr>
