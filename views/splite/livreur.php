...
body {font-family: Arial, Helvetica, sans-serif;}
		...
		<div id="app" class="page">
			<div class="main-wrapper" >
				...
				<nav class="navbar navbar-expand-lg main-navbar">
					<a class="header-brand" href="../fashe-colorlib/cart.php">
						...
						<div class="header-icons">
                               ...
                               <div><?php
                                   ...
                                   if (isset($_SESSION['l']) && isset($_SESSION['p']))
                                   {
                                       ...
                                       echo '<font color="white"> <b> '.$_SESSION['l'].'</b></font> <br>';
                                       echo '<a href="./logout.php"><font color="white">Se Déconnecter</font></a>';
       ...
       <form method="get" action="search.php">
        ...
        <form method="get" action="trier.php">
         ...
         <form method="get" action="stat.php">
       	   <input type="submit" class="btn btn-info"  value="statistique">
       </form>
    ...
    <tr>
     ...
     <td>												     
												          ...
												          <a href="modifierlivreur.php?login=<?= $livreur->login ?> "   class="btn btn-info"> modifer </a>
