			...
			<div class="main-wrapper" >
				...
				<nav class="navbar navbar-expand-lg main-navbar">
					<a class="header-brand" href="index-2.html">
						<img src="58707855_172745310336152_696196958682873856_n.png" class="header-brand-img" alt="Splite-Admin  logo">
					</a>
							...
							<div class="col-12 col-sm-12">
								<div class="card">
									<div class="card-header">
									  ...
									  <form method="get" action="impress.php">
       	   <input type="submit" class="float-right"  value="imprimer">
       </form>
											...
											<table class="table table-bordered text-nowrap mb-0">
												...
												<tbody>
												    ...
												    <tr>
												     ...
												     <td>
												              <a href="modd.php?id=<? $livraison->idcommande ?> "   class="btn btn-info"> Edit </a>

												<a onclick="return confirm('voulez vous vraiment supprimer ?')" href="supprimerlivraison.php?id=<?= $livraison->idcommande ?>" class="btn btn-danger"> Delete </a>
