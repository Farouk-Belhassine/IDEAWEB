							...
							<div class="col-12 col-sm-12">
								<div class="card">
									<div class="card-header">
									  ...
									  <form method="get" action="imprimer.php">
       	   <input type="submit" class="float-right"  value="imprimer">
       </form>
        <form method="get" action="affecter.php">
       	   <input type="submit" class="float-right"  value="affecter">
       </form>
									<div class="card-body">
											...
											<table class="table table-bordered text-nowrap mb-0">
												...
												<tbody>
												    ...
												    <tr>
												      ...
												      <td> <?php echo $livraison['datecommande'] ?></td>
												   
												    <td> <?php echo $livraison['montantcommande'] ?></td> 
												     
												      <td><?php echo $livraison['etatcommande'] ?></td>
