									...
									<div class="card-body">
										<div id="table" class="table-responsive table-editable">
											...
											<table  class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap" id="MYtable">
												<tr>
													<th onclick="sortTable1(1)" class="text-center">refcommande</th>
													<th onclick="sortTable1(2)" class="text-center">cin</th>
													<th onclick="sortTable1(3)" class="text-center">idpanier</th>
													<th onclick="sortTable1(4)" class="text-center">datelimite</th>
													<th onclick="sortTable1(5)" class="text-center">prixlivraison</th>
...
<tr>
	...
	<td><form method="POST" action="supprimercommande.php"><input class="btn btn-danger btn-rounded btn-sm my-0" type="submit"  name="supprimer" value="supprimer"><input type="hidden" name="refcommande" value='<?PHP echo $row['refcommande']; ?>'></form></td>
  <td><a href="modifiercommande.php?refcommande=<?PHP echo $row['refcommande']; ?>">Modifier</a>
  </td>
</tr>
<?php
}
