...
if (isset($_GET['refcommande'])){
    ...
    $result=$commandeC1->recuperercommande($_GET['refcommande']);
...
<tr>
<td>cin</td>
<td><input class="form-control" id="exampleInputPassword1" type="number" name="cin" value="<?PHP echo $cin ?>"></td>
</tr>
<tr>
<td>id panier</td>
<td><input class="form-control" id="exampleInputPassword1" type="number" name="idpanier" value="<?PHP echo $idpanier ?>"></td>
</tr>
<tr>
<td>date limite</td>
<td><input class="form-control" id="exampleInputPassword1" type="date" name="datelimite" value="<?PHP echo $datelimite ?>"></td>
</tr>
<tr>
<tr>
<td>prix livraison</td>
<td><input class="form-control" id="exampleInputPassword1" type="number" name="prixlivraison" value="<?PHP echo $prixlivraison ?>"></td>
</tr>
<tr>
<td></td>
...
<td></td>
<td><input type="hidden" name="refcommande" value="<?PHP echo $_GET['refcommande'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	$commande=new commande($_POST['refcommande'],$_POST['cin'],$_POST['idpanier'],$_POST['datelimite'],$_POST['prixlivraison']);
	$commandeC1->modifiercommande($commande,$_POST['refcommande']);
	echo $_POST['refcommande'];
