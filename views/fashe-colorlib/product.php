			...
			<div class="wrap_header">
				...
				<div class="wrap_menu">
					<nav class="menu">
						...
						<li class="sale-noti">
								<a href="actualitef.php">Actualite</a>
							</li>
...
<td><form method="GET" action="trie.php"> 
    <input  class="flex-c-m size2 bg4 bo-rad-23 hov1 m-text3 trans-0-4"type="submit"  name="trie descendant" value="trie descendant ">
  </form></td> </div>
  	<div class="w-size2 p-t-20">

  <td><form method="GET" action="trie_asc.php"> 
    <input  class="flex-c-m size2 bg4 bo-rad-23 hov1 m-text3 trans-0-4"type="submit"  name="trie ascendant" value="trie ascendant">
  </form></td></div>
...
include 'D:/apps/wamp64/www/sitweb/core/promotionC.php';
   ...
   $mylist1=$promo1C->afficherjoint();

   $promo2C=new promotionC();
   $mylist2=$promo2C->afficherjoint2();

   $promo3C=new promotionC();
   $mylist3=$promo3C->afficherjoint3();
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
									...
									<h2 class="block2-oldprice m-text7 p-r-5"><?PHP echo $row['Prix']; ?> DT</h2>
										<p><h2 style ="text-align:right;"><?PHP echo $row['reduction'];  ?>% </h2> 
