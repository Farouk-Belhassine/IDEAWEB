										...
										<div id="table" class="table-responsive table-editable">
											...
											<table  id="Mytable" class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												<tr>
													...
													<th  onclick="sortTable(0)"class="text-center">ID_categorie</th>
													<th  onclick="sortTable(1)"class="text-center">nom_categorie</th>
...
<tr>
   ...
   <input type="hidproduitden" value="<?PHP echo $row['ID_categorie']; ?>"name="ID_categorie">
	 </form>
  </td>
  <td><form method="GET" action="modifiercategorie.php"> 
    <input class="btn btn-danger btn-rounded btn-sm my-0" type="submit"  name="modifier" value="modifier">
   <input type="hidproduitden" value="<?PHP echo $row['ID_categorie']; ?>"name="ID_categorie">
	 </form>
  </td>
</tr>
