            ...
            <div id="app" class="page">
                <div class="main-wrapper" >
                    ...
                    <aside class="app-sidebar">
                        ...
                        <ul class="side-menu">
                            <li class="slide">
                                <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">Dashboard</span><span class="angle fa fa-angle-right"></span></a>
                                <ul class="slide-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a href="#" class="slide-item">add deliveryman</a></li>
                                    <li><a href="#" class="slide-item">remove deliveryman</a></li>
                                    <li><a href="#" class="slide-item">show deliveryman</a></li>
                                    <li><a href="#" class="slide-item">edit deliveryman</a></li>
                                    <li><a href="#" class="slide-item">add delivery</a></li>
                                    <li><a href="#" class="slide-item">remove delivery</a></li>
                                    <li><a href="#" class="slide-item">show deliveryman</a></li>
                                    <li><a href="#" class="slide-item">edit deliveryman</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="#" class="slide-item">remove ordered</a></li>
                                    <li><a href="#" class="slide-item">show ordered</a></li>
                                    <li><a href="#" class="slide-item">edit ordered</a></li>
                                    
                                    <li><a href="#" class="slide-item">remove bill</a></li>
                                    <li><a href="#" class="slide-item">show bill</a></li>
                                    <li><a href="#" class="slide-item">edit bill</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a href="#" class="slide-item">add event</a></li>
                                    <li><a href="#" class="slide-item">remove event</a></li>
                                    <li><a href="#" class="slide-item">show event</a></li>
                                    <li><a href="#" class="slide-item">edit event</a></li>
                                    <li><a href="#" class="slide-item">add promotion</a></li>
                                    <li><a href="#" class="slide-item">remove promotion</a></li>
                                    <li><a href="#" class="slide-item">show promotion</a></li>
                                    <li><a href="#" class="slide-item">edit promotion</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a href="#" class="slide-item">add coupon</a></li>
                                    <li><a href="#" class="slide-item">remove coupon</a></li>
                                    <li><a href="#" class="slide-item">show coupon</a></li>
                                    <li><a href="#" class="slide-item">edit coupon</a></li>
