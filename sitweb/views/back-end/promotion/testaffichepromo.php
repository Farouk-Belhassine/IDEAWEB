...
include '../../../core/promotionC.php';
   ...
   $mylist=$promo1C->afficherpromotion();
?>
					...
					<section class="section">
						...
						<div class="row">
										...
										<div id="table" class="table-responsive table-editable">
											<table  id="MYtable" class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												<tr >
													...
													<th onclick="sortTable(1)" class="text-center">durée</th>
													<th onclick="sortTable(2)" class="text-center">reduction</th>
                            ...
                            <div class="search-element mr-2">
								<input class="form-control" type="search" placeholder="Search" aria-label="Search"  name="id_produit" id="Search" >
...
<tr>
	...
	<td><form method="POST" action="testsupprimepromo.php"> 
  ...
  <td><a href="testmodifierpromo.php?id_produit=<?PHP echo $row['id_produit']; ?>">Modifier</a>
  </td>
