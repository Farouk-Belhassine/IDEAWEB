									...
									<div class="card-body">
										<div id="table" class="table-responsive table-editable">
											...
											<table  class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap" id="MYtable">
												<tr>
													<th onclick="sortTable1(1)" class="text-center">num</th>
													<th onclick="sortTable1(2)" class="text-center">refcommande</th>
													<th onclick="sortTable1(3)" class="text-center">datecommande</th>
...
<tr>
	...
	<td><form method="POST" action="supprimerfacture.php"><input class="btn btn-danger btn-rounded btn-sm my-0" type="submit"  name="supprimer" value="supprimer"><input type="hidden" name="num" value='<?PHP echo $row['num']; ?>'></form></td>
  <td><a href="modifierfacture.php?num=<?PHP echo $row['num']; ?>">Modifier</a>
  </td>
</tr>
<?php
}
