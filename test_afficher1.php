								...
								<div class="card">
									...
									<div class="card-body">
										...
										<table id="myTable" class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												<tr>
													<th onclick="sortTable(0)" class="text-center">cin</th>
													<th onclick="sortTable(1)" class="text-center">reclamation</th>
...
<tr>
	...
	<td><form method="POST" action="supprimer1.php"> 
