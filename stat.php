...
{
 $chart_data .= "{ idproduit:'".$row["idproduit"]."', quantite:".$row["quantite"]."}, ";
}
...
body {font-family: Arial, Helvetica, sans-serif;}
  ...
  <div class="container" style="width:900px;">
   ...
   <h3 align="center" style="color:rgb(44, 172, 171)">des produits selon la quantité  </h3>   
   <br /><br />
   <div id="chart"></div>
  </div>
										</div>
...
Morris.Bar({
 ...
 data:[<?php echo $chart_data; ?>],
 xkey:'idcommande',
 ykeys:['profit', 'prixlivraison'],
 labels:['idcommande', 'prixlivraison' ],
 hideHover:'auto',
 stacked:true
});
</script>